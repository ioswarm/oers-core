...
exec "$JAVACMD" -Dvertx.logger-delegate-factory-class-name=io.vertx.core.logging.Log4jLogDelegateFactory -Dlog4j.configuration=log4j.properties -classpath "$CLASSPATH" OERS "$@"
